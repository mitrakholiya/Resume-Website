    ...
    <>
      ...
      <div className="container-fluid bg-[#E6DACE] pb-[100px]">
        <div className='flex justify-center items-center py-[70px]'>
          ...
          <span className='text-[38px] text-black font-bold'>Let's talk</span>
        </div>
        <div className="container-small py-[20px] px-[40px] bg-white">
          <form action="" className='font-bold text-[14px]'>
            ...
            <div className="flex flex-col sm:flex-row justify-between">
              ...
              <div className='sm:w-[45%] pt-[20px] sm:py-[0px]'>
